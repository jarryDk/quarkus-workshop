...
All containers in this workshop can be started and removed be ansible playbooks. Just go to link:ansiblie-playbook/README.adoc[ansiblie-playbook/README.adoc].
...
[source,bash]
----
./target/todo-app-1.0.0-SNAPSHOT-runner
----
...
Website for https://microprofile.io/[microprofile.io - MicroProfile]

https://github.com/eclipse/microprofile/releases/tag/4.0[MicroProfile 4.0] on github.

.MicroProfile 4.0
image::images/MicroProfile4-768x344.png[MicroProfile 4.0]



Update to MicroProfile 4.0 comes with Quarkus 2.0.0.Final.
