...
public class ToDoService {
    ...
    @Inject 
    @Channel("todo-out") 
    Emitter<ToDo> toDoEmitter;
    
    public ToDo process(ToDo toDo) {
        toDo.subject = toDo.subject + " Kafka " + ZonedDateTime.now().format(DateTimeFormatter.ISO_INSTANT);
        toDoEmitter.send(toDo);
        return toDo;
    }
